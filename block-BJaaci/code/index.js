...
console.log (movies[0].genres[movies[0].actors.length-1])

// 17. Log the first genres of the second movie (using the length property of array)
console.log (movies[movies.length-2].genres[movies[0].actors.length-3])

// 18. Log all the genres of the first movie one by one
let gen = 0
for (let i = 0; i < movies.length; i++){
  gen = movies[0].genres[i];
  console.log (gen)
}  
